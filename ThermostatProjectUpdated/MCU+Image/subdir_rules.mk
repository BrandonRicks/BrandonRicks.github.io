...
%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"E:/Programming/CCStudio IDE/ccs/tools/compiler/ti-cgt-arm_20.2.6.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=none -me -O4 --include_path="E:/Programming/Projects/Code Composer Projects/ThermostatProject" --include_path="E:/Programming/Projects/Code Composer Projects/ThermostatProject/MCU+Image" --include_path="E:/Programming/CCStudio IDE/ti/simplelink_cc32xx_sdk_6_10_00_05/source" --include_path="E:/Programming/CCStudio IDE/ti/simplelink_cc32xx_sdk_6_10_00_05/kernel/nortos" --include_path="E:/Programming/CCStudio IDE/ti/simplelink_cc32xx_sdk_6_10_00_05/kernel/nortos/posix" --include_path="E:/Programming/CCStudio IDE/ccs/tools/compiler/ti-cgt-arm_20.2.6.LTS/include" --define=NORTOS_SUPPORT -g --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" --include_path="E:/Programming/Projects/Code Composer Projects/ThermostatProject/MCU+Image/syscfg" $(GEN_OPTS__FLAG) "$<"
...
syscfg/%.obj: ./syscfg/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: Arm Compiler'
	"E:/Programming/CCStudio IDE/ccs/tools/compiler/ti-cgt-arm_20.2.6.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=none -me -O4 --include_path="E:/Programming/Projects/Code Composer Projects/ThermostatProject" --include_path="E:/Programming/Projects/Code Composer Projects/ThermostatProject/MCU+Image" --include_path="E:/Programming/CCStudio IDE/ti/simplelink_cc32xx_sdk_6_10_00_05/source" --include_path="E:/Programming/CCStudio IDE/ti/simplelink_cc32xx_sdk_6_10_00_05/kernel/nortos" --include_path="E:/Programming/CCStudio IDE/ti/simplelink_cc32xx_sdk_6_10_00_05/kernel/nortos/posix" --include_path="E:/Programming/CCStudio IDE/ccs/tools/compiler/ti-cgt-arm_20.2.6.LTS/include" --define=NORTOS_SUPPORT -g --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --preproc_with_compile --preproc_dependency="syscfg/$(basename $(<F)).d_raw" --include_path="E:/Programming/Projects/Code Composer Projects/ThermostatProject/MCU+Image/syscfg" --obj_directory="syscfg" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
